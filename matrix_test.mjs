...
import { mat4, quat, vec3 } from './lib/gl-matrix-wrapper.js';
...
const specView3 = mat4.create();
mat4.multiply(specView3, liveDesktopView, relativeScaleMat);
mat4.multiply(specView3, specView3, invScaledPanPos);
...
console.log("Scale first virt pipeline trans:", [specView3[12].toFixed(2), specView3[13].toFixed(2), specView3[14].toFixed(2)]);
