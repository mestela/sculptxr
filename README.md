...
*   v0.9.217 - v0.9.230: **Voxel Cube Brush & Performance Optimization:** Added a new 'Cube' brush shape to the Voxel tool that can be oriented 1:1 with the physical VR controller. Offloaded all heavy Voxel normal calculations to the Web Worker and fixed a critical "Wireframe Rebuild Paradox" to permanently eliminate standalone CPU stuttering during rapid sculpting.
