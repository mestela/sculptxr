...
2.  **Naming**: Stop inventing new doc names. Stick to:
    -   `task.md` (Checklist)
...
**File Naming**: `handover_prompt_latest.md` (But actually refer to `handover_prompt.md` in general context as the primary).
